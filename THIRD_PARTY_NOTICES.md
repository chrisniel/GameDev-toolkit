...
The Unity workflow reference adapts selected documentation ideas from CoplayDev Unity MCP v10.1.2. See the [source inventory and complete MIT notice](skills/gamedev-unity-development/references/source-notices.md), which travels with the Unity skill.
